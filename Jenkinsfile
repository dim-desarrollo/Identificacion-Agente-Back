        ...
        steps {
            script {
                ...
                dir ("${CARPETA_APLICACION}"){
                    ...
                    sh "docker run -p ${PUERTO_EXTERNO}:${PUERTO_INTERNO} --network estaciones_my-network-inspector --name ${NOMBRE_CONTENEDOR} ${IDENTIFICADOR_IMAGEN} -e ASPNETCORE_ENVIROMENT=Production"
